# Webcam capture for LLaVA model
# This demonstrates how to capture frames from webcam and use them as images
...
def capture_webcam_frames(duration_seconds=3, fps=4):
...
def main():
    # Capture frames from webcam for 3 seconds
